...
const META = {
  "Argentina":             { code: "ARG", flag: "ar",     fr: "Argentine",          en: "Argentina",            pt: "Argentina",             es: "Argentina" , it: "Argentina" },
  "France":                { code: "FRA", flag: "fr",     fr: "France",             en: "France",               pt: "França",                es: "Francia" , it: "Francia" },
  "Spain":                 { code: "ESP", flag: "es",     fr: "Espagne",            en: "Spain",                pt: "Espanha",               es: "España" , it: "Spagna" },
  "England":               { code: "ENG", flag: "gb-eng", fr: "Angleterre",         en: "England",              pt: "Inglaterra",            es: "Inglaterra" , it: "Inghilterra" },
  "Brazil":                { code: "BRA", flag: "br",     fr: "Brésil",             en: "Brazil",               pt: "Brasil",                es: "Brasil" , it: "Brasile" },
  "Morocco":               { code: "MAR", flag: "ma",     fr: "Maroc",              en: "Morocco",              pt: "Marrocos",              es: "Marruecos" , it: "Marocco" },
  "Portugal":              { code: "POR", flag: "pt",     fr: "Portugal",           en: "Portugal",             pt: "Portugal",              es: "Portugal" , it: "Portogallo" },
  "Netherlands":           { code: "NED", flag: "nl",     fr: "Pays-Bas",           en: "Netherlands",          pt: "Países Baixos",         es: "Países Bajos" , it: "Paesi Bassi" },
  "Germany":               { code: "GER", flag: "de",     fr: "Allemagne",          en: "Germany",              pt: "Alemanha",              es: "Alemania" , it: "Germania" },
  "Belgium":               { code: "BEL", flag: "be",     fr: "Belgique",           en: "Belgium",              pt: "Bélgica",               es: "Bélgica" , it: "Belgio" },
  "Croatia":               { code: "CRO", flag: "hr",     fr: "Croatie",            en: "Croatia",              pt: "Croácia",               es: "Croacia" , it: "Croazia" },
  "Mexico":                { code: "MEX", flag: "mx",     fr: "Mexique",            en: "Mexico",               pt: "México",                es: "México" , it: "Messico" },
  "Colombia":              { code: "COL", flag: "co",     fr: "Colombie",           en: "Colombia",             pt: "Colômbia",              es: "Colombia" , it: "Colombia" },
  "United States":         { code: "USA", flag: "us",     fr: "États-Unis",         en: "United States",        pt: "Estados Unidos",        es: "Estados Unidos" , it: "Stati Uniti" },
  "Senegal":               { code: "SEN", flag: "sn",     fr: "Sénégal",            en: "Senegal",              pt: "Senegal",               es: "Senegal" , it: "Senegal" },
  "Japan":                 { code: "JPN", flag: "jp",     fr: "Japon",              en: "Japan",                pt: "Japão",                 es: "Japón" , it: "Giappone" },
  "Uruguay":               { code: "URU", flag: "uy",     fr: "Uruguay",            en: "Uruguay",              pt: "Uruguai",               es: "Uruguay" , it: "Uruguay" },
  "Switzerland":           { code: "SUI", flag: "ch",     fr: "Suisse",             en: "Switzerland",          pt: "Suíça",                 es: "Suiza" , it: "Svizzera" },
  "Austria":               { code: "AUT", flag: "at",     fr: "Autriche",           en: "Austria",              pt: "Áustria",               es: "Austria" , it: "Austria" },
  "Korea Republic":        { code: "KOR", flag: "kr",     fr: "Corée du Sud",       en: "South Korea",          pt: "Coreia do Sul",         es: "Corea del Sur" , it: "Corea del Sud" },
  "Australia":             { code: "AUS", flag: "au",     fr: "Australie",          en: "Australia",            pt: "Austrália",             es: "Australia" , it: "Australia" },
  "Iran":                  { code: "IRN", flag: "ir",     fr: "Iran",               en: "Iran",                 pt: "Irã",                   es: "Irán" , it: "Iran" },
  "Türkiye":               { code: "TUR", flag: "tr",     fr: "Turquie",            en: "Türkiye",              pt: "Turquia",               es: "Turquía" , it: "Turchia" },
  "Norway":                { code: "NOR", flag: "no",     fr: "Norvège",            en: "Norway",               pt: "Noruega",               es: "Noruega" , it: "Norvegia" },
  "Ecuador":               { code: "ECU", flag: "ec",     fr: "Équateur",           en: "Ecuador",              pt: "Equador",               es: "Ecuador" , it: "Ecuador" },
  "Egypt":                 { code: "EGY", flag: "eg",     fr: "Égypte",             en: "Egypt",                pt: "Egito",                 es: "Egipto" , it: "Egitto" },
  "Côte d'Ivoire":         { code: "CIV", flag: "ci",     fr: "Côte d'Ivoire",      en: "Ivory Coast",          pt: "Costa do Marfim",       es: "Costa de Marfil" , it: "Costa d'Avorio" },
  "Algeria":               { code: "ALG", flag: "dz",     fr: "Algérie",            en: "Algeria",              pt: "Argélia",               es: "Argelia" , it: "Algeria" },
  "Canada":                { code: "CAN", flag: "ca",     fr: "Canada",             en: "Canada",               pt: "Canadá",                es: "Canadá" , it: "Canada" },
  "Panama":                { code: "PAN", flag: "pa",     fr: "Panama",             en: "Panama",               pt: "Panamá",                es: "Panamá" , it: "Panama" },
  "Sweden":                { code: "SWE", flag: "se",     fr: "Suède",              en: "Sweden",               pt: "Suécia",                es: "Suecia" , it: "Svezia" },
  "Scotland":              { code: "SCO", flag: "gb-sct", fr: "Écosse",             en: "Scotland",             pt: "Escócia",               es: "Escocia" , it: "Scozia" },
  "Paraguay":              { code: "PAR", flag: "py",     fr: "Paraguay",           en: "Paraguay",             pt: "Paraguai",              es: "Paraguay" , it: "Paraguay" },
  "Congo DR":              { code: "COD", flag: "cd",     fr: "RD Congo",           en: "DR Congo",             pt: "RD Congo",              es: "RD Congo" , it: "RD Congo" },
  "Czech Republic":        { code: "CZE", flag: "cz",     fr: "Rép. Tchèque",       en: "Czechia",              pt: "Tchéquia",              es: "Chequia" , it: "Cechia" },
  "Qatar":                 { code: "QAT", flag: "qa",     fr: "Qatar",              en: "Qatar",                pt: "Catar",                 es: "Catar" , it: "Qatar" },
  "Uzbekistan":            { code: "UZB", flag: "uz",     fr: "Ouzbékistan",        en: "Uzbekistan",           pt: "Uzbequistão",           es: "Uzbekistán" , it: "Uzbekistan" },
  "Tunisia":               { code: "TUN", flag: "tn",     fr: "Tunisie",            en: "Tunisia",              pt: "Tunísia",               es: "Túnez" , it: "Tunisia" },
  "Saudi Arabia":          { code: "KSA", flag: "sa",     fr: "Arabie Saoudite",    en: "Saudi Arabia",         pt: "Arábia Saudita",        es: "Arabia Saudí" , it: "Arabia Saudita" },
  "Iraq":                  { code: "IRQ", flag: "iq",     fr: "Irak",               en: "Iraq",                 pt: "Iraque",                es: "Irak" , it: "Iraq" },
  "South Africa":          { code: "RSA", flag: "za",     fr: "Afrique du Sud",     en: "South Africa",         pt: "África do Sul",         es: "Sudáfrica" , it: "Sudafrica" },
  "Bosnia and Herzegovina":{ code: "BIH", flag: "ba",     fr: "Bosnie-Herzégovine", en: "Bosnia & Herzegovina", pt: "Bósnia e Herzegovina",  es: "Bosnia y Herzegovina" , it: "Bosnia ed Erzegovina" },
  "Cape Verde Islands":    { code: "CPV", flag: "cv",     fr: "Cap-Vert",           en: "Cape Verde",           pt: "Cabo Verde",            es: "Cabo Verde" , it: "Capo Verde" },
  "Jordan":                { code: "JOR", flag: "jo",     fr: "Jordanie",           en: "Jordan",               pt: "Jordânia",              es: "Jordania" , it: "Giordania" },
  "Ghana":                 { code: "GHA", flag: "gh",     fr: "Ghana",              en: "Ghana",                pt: "Gana",                  es: "Ghana" , it: "Ghana" },
  "New Zealand":           { code: "NZL", flag: "nz",     fr: "Nouvelle-Zélande",   en: "New Zealand",          pt: "Nova Zelândia",         es: "Nueva Zelanda" , it: "Nuova Zelanda" },
  "Curacao":               { code: "CUW", flag: "cw",     fr: "Curaçao",            en: "Curaçao",              pt: "Curaçao",               es: "Curazao" , it: "Curaçao" },
  "Haiti":                 { code: "HAI", flag: "ht",     fr: "Haïti",              en: "Haiti",                pt: "Haiti",                 es: "Haití" , it: "Haiti" }
};

function meta(name) {
  return META[name] || { code: (name || "—").slice(0, 3).toUpperCase(), flag: "", fr: name || "—", en: name || "—", pt: name || "—", es: name || "—", it: name || "—" };
}
